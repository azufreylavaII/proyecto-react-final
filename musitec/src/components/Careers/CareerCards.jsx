        ...
        <>
            <div className="containerCareerCards">
                <div className="containerCareer">
                    <div className="containerImageCareer"
                        style={{
                    ...
                    <p className="textCareer">
                        La interpretación musical es el proceso de producir música, y el licenciado en
                        esta disciplina es un profesional especializado en el arte musical, con conocimientos
                        teóricos y prácticos, y formación en 22 especialidades.
                    </p>
                ...
                <div className="containerCareer">
                    <div className="containerImageCaree"
                        style={{
                    ...
                    <p className="textCareer">
                        La producción musical abarca la creación y perfeccionamiento de canciones.
                        La composición combina sonidos y ritmos. Un licenciado en Producción y Composición
                        domina todo el proceso y su contexto.
                    </p>
                    <button className="buttonCareer" onClick={() => redireccion('')}>
                        VER MALLA CURRICULAR
                    </button>
                ...
                <div className="containerCareer">
                    ...
                    <p className="textCareer">
                        La pedagogía musical estudia y enseña música con métodos adaptados a cada alumno.
                        Un licenciado en esta área es experto en enseñanza musical y su contexto.
                    </p>
                    <button className="buttonCareer" onClick={() => redireccion('')}>
                        VER MALLA CURRICULAR
                    </button>
